...
while True:
    ...
    try:
        ...
        if user_input in custom_commands:
            ...
            if any(command in user_input for command in custom_commands):
                if 'weather' in user_input:
                    ...
                    if location:
                        ...
                        api_key = "3fb20f0e14a9a4d15ea2bff6edd15184"  # Replace with your actual API key from OpenWeatherMap
                    ...
                    bot_response = custom_commands.get(user_input, "Unknown command. Type '\\help' for available commands.")
            else:
                bot_response = "Unknown command. Type '\\help' for available commands."
        elif any(greeting in user_input for greeting in greetings) and not user_input.startswith('open youtube'):
            ...
            bot_response = "I don't have knowledge about that."
        ...
        print("Speech recognition could not understand you well.")
